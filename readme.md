...
``` bash
composer require fournodes/import-operation
```
...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'fournodes.import-operation::fields',
]);
```
...
cp -i vendor/fournodes/import-operation/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove fournodes/import-operation
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/fournodes/import-operation/releases).
...
If you discover any security related issues, please email contact@four-nodes.com instead of using the issue tracker.

## Credits

- [Fournodes LLC][link-author]
...
[ico-version]: https://img.shields.io/packagist/v/fournodes/import-operation.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/fournodes/import-operation.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/fournodes/import-operation
[link-downloads]: https://packagist.org/packages/fournodes/import-operation
[link-author]: https://github.com/fournodes
